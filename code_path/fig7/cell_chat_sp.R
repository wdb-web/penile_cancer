...
adata$obs$cell_type %>% table
adata$obs$refined_cell_type %>% table
...
adata_meta.data$cell_type[match(rownames(meta.data),rownames(adata_meta.data))][meta.data$cell_type_sub!="CD74 B cells"]=paste0(
meta.data$cell_type_sub)[meta.data$cell_type_sub!="CD74 B cells"] 
...
saveRDS(cellchat_run,"/home/wangdongbin/data/2024/2024_7_13_E007_TLS/output/fig7/cellchat_k.min_5.RDS")  

#cellchat=readRDS("/home/wangdongbin/data/2024/2024_7_13_E007_TLS/output/fig3/cellchat.RDS")  
names(cellchat_run)=meta.data$sample_id%>%unique
cellchat_run=readRDS("/home/wangdongbin/data/2024/2024_7_13_E007_TLS/output/fig7/cellchat_k.min_5.RDS")  
...
pdf("/home/wangdongbin/data/2024/2024_7_13_E007_TLS/output/fig7/细胞通讯/net.pdf",width=12, height=12)
netVisual_circle(cell_chat_count[c("TLS_CD74 B cells","nTLS_CD74 B cells",#"Fibroblast"   ,
"Myeloid" ,"NK" ,"Th17","Th1","NK & T" ,

"TLS_Naive T","nTLS_Naive T","DC"),c("TLS_CD74 B cells","nTLS_CD74 B cells",#"Fibroblast"   ,
"Myeloid" ,"NK" ,"Th17","Th1","NK & T" ,

"TLS_Naive T","nTLS_Naive T","DC")] %>% as.matrix, weight.scale = T, label.edge= F)
dev.off()
...
bind_net_count=bind_net_count %>% filter(from %in% c("TLS_CD74 B cells","nTLS_CD74 B cells") & to %in% c("TLS_Naive T","nTLS_Naive T"))
...
ggsave("/data/project/wangdongbin/data/2024/2024_7_13_E007_TLS/output/fig7/cell_chat_netVisual_bubble_from.pdf",
